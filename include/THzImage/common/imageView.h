...
public:
    ...
    /// @param imageDimensions The dimensions of the image buffer.
    /// @param region The region inside the image buffer.
    ImageView(pointer const basePtr, Rectangle const &imageDimensions, Rectangle const &region) noexcept
        : _basePointer{basePtr}, _imageDimensions{imageDimensions}, _region{region}
    {}
